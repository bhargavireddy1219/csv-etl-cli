...
1. Created a GitHub repo with Financial transcations dataset
...
5. As I have used windows task scheduler is available to schedule daily run sample etl with Financial transcations dataset
